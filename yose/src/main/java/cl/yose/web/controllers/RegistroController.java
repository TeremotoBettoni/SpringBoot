...
public class RegistroController {
	...
	public String guardarFormulario(@RequestParam("nombre") String nombre, @RequestParam("apellido") String apellido,
			...
			@RequestParam("contraseña2") String contraseña2, Model model) { // model nos permite enviar respuestas o
																			// traspasar info
	...
	public String ingresoUsuario(@RequestParam("email") String email, @RequestParam("contraseña") String contraseña,
		...
		if (resultadoLogin) { // resultadoLogin == true, login correcto
			...
			model.addAttribute("msgError", "email o contraseña invalidas o no existen");
			return "login.jsp";
		}
	}
