...
<!-- La linea 3 es lña libreria tag que nos permite validar informacion -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
	    ...
	    <div class="card">
		  <div class="card-body">
		    <form action="/registro/formulario" method="post">
		        ...
		        <input type="password" class="form-control" id="pass2" name="pass2" placeholder="confirme password">
		        <br>
